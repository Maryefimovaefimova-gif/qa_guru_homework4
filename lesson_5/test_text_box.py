...
def test_long_input_fields(driver, field_type, long_string):
    ...
    if field_type == "name":
        page.fill_form(name=long_string)
    elif field_type == "email":
        page.fill_form(email=long_string)
    elif field_type == "cur_addr":
        page.fill_form(cur_addr=long_string)
    elif field_type == "perm_addr":
        page.fill_form(perm_addr=long_string)
